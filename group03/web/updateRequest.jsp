                ...
                <div class="row mb-4">
                    <div class="col-auto" style="display: flex;">
                        ...
                        <div class="balance-box border border-primary rounded p-2" style="max-width: 150px;">
                            ...
                            <p class="text-success mb-0" ><fmt:formatNumber value="${wallet.balance}" type="number" maxFractionDigits="2" />₫</p> 
                        </div>
                        <div class="balance-box border border-primary rounded p-2" style="max-width: 150px; margin-left: 50px">
                            ...
                            <p  class="text-red mb-0"><fmt:formatNumber value="${wallet.hold}" type="number" maxFractionDigits="2" />₫</p> 
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12"> 
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <c:forEach items="${slotList}" var="s">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input type="checkbox" 
                                                                           class="checkbox slot-checkbox" 
                                                                           name="addSlot" 
                                                                           value="${s.slotID}" 
                                                                           data-day="${s.dayInWeek}"
                                                                           ${isDisabled ? 'disabled' : ''}
                                                                           <c:forEach items="${checkedSlot}" var="c">
                                                                               <c:if test="${c.slotId == s.slotID}">checked</c:if>
                                                                           </c:forEach>
                                                                           />
                                                                </td>
                                                                <td>${s.dayInWeek}</td>
                                        ...
                                        <div class="summary-section border rounded p-3 mt-3 bg-light">
                                            <div class="row mb-2">
                                                <div class="col-6">
                                                    <p class="mb-1"><strong>Slot Price:</strong></p>
                                                </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-6">
                                                    <p class="mb-1"><strong>Total Slot Count:</strong></p>
                                                </div>
                                                <div class="col-6 text-end">
                                                    <p id="daysCount">0</p>
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-6 text-end">
                                                    <p id="totalPrice" class="text-success"></p>
                                                </div>
                                            </div>
