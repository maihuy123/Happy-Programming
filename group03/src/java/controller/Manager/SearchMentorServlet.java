 ...
 * @author ADMIN
 */
@WebServlet(name="SearchMentorServlet", urlPatterns={"/managersearch"})
public class SearchMentorServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SearchMentorServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SearchMentorServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        String search = request.getParameter("mentor");
       //System.out.println(search);
        
        String error = request.getParameter("error");
        CVDAO cvd = new CVDAO();
        List<Mentor> listMentor = cvd.getListofMentorbyName(search);
